package pro.sky.homework216.service;

import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import pro.sky.homework216.exception.InvalidIndexException;
import pro.sky.homework216.exception.NoItemException;
import pro.sky.homework216.exception.NullItemException;

import static pro.sky.homework216.service.IntSort.*;
import static pro.sky.homework216.service.IntegerSearch.binaryIntegerSearch;
import static pro.sky.homework216.service.IntegerSort.*;
import static pro.sky.homework216.service.IntegerUtilities.generateRandomIntegerArray;
...
//        Подготовка: добавлено несколько элементов
    ...
    @Test
    void shouldConteinsWithBinarySearchCorrect() {
...
//        Подготовка: добавлено несколько элементов
        ...
        //        Тест: поиск элемента
        Assertions.assertTrue(integerList.containsWithBinarySearch(1));
        //        Тест: поиск элемента
        Assertions.assertTrue(integerList.containsWithBinarySearch(3));
        //        Тест: поиск элемента
        Assertions.assertTrue(integerList.containsWithBinarySearch(5));

        //        Тест: поиск элемента (элемент не найден)
        Assertions.assertFalse(integerList.containsWithBinarySearch(7));
...
//                  Подготовка
    ...
    @Test
    void shouldSortIntBubbleCorrect() {

        //      Подготовка: генерация массива
        int[] intTestArray1 = generateRandomIntArray(30);
    ...
    @Test
    void shouldSortIntSelection() {

        //      Подготовка: генерация массива
        int[] intTestArray2 = generateRandomIntArray(30);
        //      Сортировка выбором
    ...
    @Test
    void shouldSortIntInsertion() {

        //      Подготовка: генерация массива
        int[] intTestArray3 = generateRandomIntArray(30);
        //      Сортировка вставкой
    ...
    @Test
    void shouldSortIntegerBubbleCorrect() {

        //      Подготовка: генерация массива
        Integer[] integerTestArray1 = generateRandomIntegerArray(30);
        //      Сортировка пузырьковая
        sortIntegerBubble(integerTestArray1, 30);

    }

    @Test
    void shouldSortIntegerSelection() {

        //      Подготовка: генерация массива
        Integer[] integerTestArray2 = generateRandomIntegerArray(30);
        //      Сортировка выбором
        sortIntegerSelection(integerTestArray2, 30);

    }

    @Test
    void shouldSortIntegerInsertion() {

        //      Подготовка: генерация массива
        Integer[] integerTestArray3 = generateRandomIntegerArray(30);
        //      Сортировка вставкой
        sortIntegerInsertion(integerTestArray3, 30);

    }

    @Test
    void shouldBinaryIntegerSearch() {
        ...
        Integer[] iTestA = integerList.toArray();

        //        Тест: проверка
        Assertions.assertTrue(binaryIntegerSearch(iTestA, 3, 1));
        Assertions.assertTrue(binaryIntegerSearch(iTestA, 3, 2));
        Assertions.assertTrue(binaryIntegerSearch(iTestA, 3, 3));
        //        Тест: проверка (нет элемента)
        Assertions.assertFalse(binaryIntegerSearch(iTestA, 3, 7));
